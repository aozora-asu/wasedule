...
final StreamController<TaskNotification> didTaskLocalNotificationStream =
    StreamController<TaskNotification>.broadcast();
...
Future<void> initialize() async {
  ...
  final DarwinInitializationSettings initializationSettingsDarwin =
    ...
    onDidReceiveLocalNotification:
      ...
      didTaskLocalNotificationStream.add(
        TaskNotification(
          id: id,
          title: title,
          body: body,
...
Future<bool?> requestPermissions() async {
  ...
  // プラットフォームがサポートされていない場合や、実装がない場合は false を返す
  return false;
}
