...
class _CourseAddPageState extends ConsumerState<CourseAddPage> {
      ...
      child: Padding(
          ...
          child:Column(
           ...
           children:[
            ...
            Row(children:[
              textFieldModel("授業名…",classNameController,FontWeight.normal,
              (value){}),
            ]),
            ...
            Row(children:[
              ...
              SizedBox(width: SizeConfig.blockSizeHorizontal! *3),
              textFieldModel(
                "教室…",classRoomController,FontWeight.normal,
                (value){})
            ]),
            ...
            Row(children:[
              ...
              isBalid() ? ACCENT_COLOR : Colors.grey
              ,"   追加   "
              ),
              SizedBox(width: SizeConfig.blockSizeHorizontal! *1),
            ])
  ...
  Future<String> showWeekdayAndPeriodDialogue() async{
    ...
    List<int> yearList = [
      now - 10, now - 9, now - 8, now - 7, now - 6, now - 5, now - 4, now - 3, now - 2, now - 1, now,
      now + 1, now + 2, now + 3, now + 4, now + 5, now + 6, now + 7, now + 8, now + 9, now + 10
    ];
